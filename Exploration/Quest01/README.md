...
- [ O ] **1. 주어진 문제를 해결하는 완성된 코드가 제출되었나요?**
  - 문제에서 요구하는 최종 결과물이 첨부되었는지 확인
    - 중요! 해당 조건을 만족하는 부분을 캡쳐해 근거로 첨부
      - Project 1 Result
        ![Project 1 MSE값](project1_mse.png)
        MSE 값 2967.8 달성 (<3000)

      - Project 2 Result
        ![Project 2 RMSE값](project2_rmse.png)
...
- [ O ] **2. 전체 코드에서 가장 핵심적이거나 가장 복잡하고 이해하기 어려운 부분에 작성된
      ...
      - 필요 부분에 적절히 주석처리되어 있음 
        ![annotation1](annotation1.png)
        ![annotation2](annotation2.png)
...
- [ O ] **3. 에러가 난 부분을 디버깅하여 문제를 해결한 기록을 남겼거나
      ...
      - 디버깅이나 문제해결과정을 확인하지는 못하였습니다. (주석이나 기록 없음)
      - "# 사실 epoch 엄청 높이면 계속 내려가긴 함 (심히 과적합)" 등의 실험 과정에 주석으로 남겨져 있습니다.
